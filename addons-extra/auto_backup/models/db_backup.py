    ...
    def schedule_backup(self):
        ...
        for rec in conf_ids:
            ...
            try:
                ...
                fp.close()
                template_id = self.env.ref('auto_backup.auto_backup_mail_template_success')
                if template_id:
                ...
                failed_template_id = self.env.ref('auto_backup.auto_backup_mail_template_failed')
                if failed_template_id:
                	failed_template_id.send_mail(self.id, force_send=True)
                continue
